        ...
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="suppliments.php">
              <i class="material-icons">Supplements</i>
              <p>Stock</p>
            </a>
          </li>
          <!-- your sidebar here -->
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Deshboard/Add Stock </a>
          </div>
      ...
      <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card-body">
                  <form id ="addstock" action="insertstock.php" method="POST">
                    ...
                    <div class="col-lg-4 col-md-12">
                      ...
                      <div class="col-lg-4 col-md-12">
                        <div class="form-group">
                          ...
                          <div class="input-group mb-4 mr-sm-4">
                          <input type="text" id="buyingprice" name="buyingprice" class="form-control">
