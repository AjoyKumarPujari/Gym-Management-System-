              ...
              <div class="card-body">
                  <form id ="addstaff" action="staffeditsubmit.php" method="POST">
                    ...
                    <div class="form-group ">
                        ...
                        <option selected="selected"><?php echo $data["stafftype"]; ?></option>
                    ...
                    <div class="row">
                      <div class="col-lg-3 col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="phonenumber" name="phonenumber" class="form-control" value="<?php echo $data['phonenumber'];?>">
                      ...
                      <div class="col-lg-3 col-md-12">
                        <div class="form-group">
                          ...
                          <div class="input-group mb-4 mr-sm-4">
                          <input type="text" id="altphonenumber" name="altphonenumber" class="form-control" value="<?php echo $data['altphonenumber'];?>">
